...
function loop() {
  ...
  }, { type: 'terrain', terrain: 'wall', x: 28, y: 35 }, { type: 'terrain', terrain: 'wall', x: 29, y: 35 }, { type: 'terrain', terrain: 'plain', x: 30, y: 35 }, { type: 'terrain', terrain: 'plain', x: 31, y: 35 }, { type: 'terrain', terrain: 'plain', x: 32, y: 35 }, { type: 'terrain', terrain: 'plain', x: 33, y: 35 }, { type: 'terrain', terrain: 'plain', x: 34, y: 35 }, { type: 'terrain', terrain: 'plain', x: 35, y: 35 }, { type: 'terrain', terrain: 'plain', x: 36, y: 35 }, { type: 'terrain', terrain: 'plain', x: 37, y: 35 }, { type: 'terrain', terrain: 'plain', x: 38, y: 35 }, { type: 'terrain', terrain: 'plain', x: 39, y: 35 }, { type: 'terrain', terrain: 'wall', x: 28, y: 36 }, { type: 'terrain', terrain: 'plain', x: 29, y: 36 }, { type: 'terrain', terrain: 'plain', x: 30, y: 36 }, { type: 'terrain', terrain: 'plain', x: 31, y: 36 }, { type: 'terrain', terrain: 'plain', x: 32, y: 36 }, { type: 'terrain', terrain: 'plain', x: 33, y: 36 }, { type: 'terrain', terrain: 'plain', x: 34, y: 36 }, { type: 'terrain', terrain: 'plain', x: 35, y: 36 }, { type: 'terrain', terrain: 'plain', x: 36, y: 36 }, { type: 'terrain', terrain: 'plain', x: 37, y: 36 }, { type: 'terrain', terrain: 'plain', x: 38, y: 36 }, { type: 'terrain', terrain: 'plain', x: 39, y: 36 }, { type: 'terrain', terrain: 'plain', x: 28, y: 37 }, { type: 'terrain', terrain: 'plain', x: 29, y: 37 }, { type: 'terrain', terrain: 'plain', x: 30, y: 37 }, { type: 'terrain', terrain: 'plain', x: 31, y: 37 }, { type: 'terrain', terrain: 'plain', x: 32, y: 37 }, { type: 'terrain', terrain: 'plain', x: 33, y: 37 }, { type: 'terrain', terrain: 'plain', x: 34, y: 37 }, { type: 'terrain', terrain: 'plain', x: 35, y: 37 }, { type: 'terrain', terrain: 'plain', x: 36, y: 37 }, { type: 'terrain', terrain: 'plain', x: 37, y: 37 }, { type: 'terrain', terrain: 'plain', x: 38, y: 37 }, { type: 'terrain', terrain: 'plain', x: 39, y: 37 }];
